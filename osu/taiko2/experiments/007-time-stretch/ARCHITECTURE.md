# Experiment 007 — Time-stretch augmentation · Architecture
...
= (80, 1000)` tensor with the cursor pinned at frame index `a_bins = 500`.
...
**Total parameters: ≈ 16.5 M.**

Conditioning MLP (3 → 64 → 64), conv stem (Conv1d(80→192, k=7, s=2)
