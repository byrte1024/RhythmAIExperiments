...
| [020b](020b-legible-dreams/) | Legible audio dreams | `Planned` | Rerun of #020 with `--preset legible`: 3x lower TV/L2, strong realism penalty (lambda=0.01), realistic per-band initialization. Adam retained. Goal: structured dreamed spectrograms with visible onset transients and listenable Griffin-Lim audio, rather than the near-zero-energy dreams from #020. |
