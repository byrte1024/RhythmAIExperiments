...
| [018](018-baselines/) | External baseline benchmarks | `Planned` | No-training experiment. Benchmark Mapperatorinator2, madmom, librosa, and optionally BeatThis! on the same val charts using `gt_match_metrics`. Contextualizes #017e and #007 against existing tools. |
