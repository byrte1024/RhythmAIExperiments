...
| [017f](017f-framewise-bce-metrics-rerun/) | Framewise BCE metrics rerun | `Planned` | 1:1 re-training of #017e with upgraded metrics: FPS-resolution comparisons (binary P/R/F1 + count MAE/corr at 8 FPS levels), standard precision/recall/F1, distributional comparison metrics (gap/ratio TVD, density correlation, silence/dense overlap), dense histograms, per-chart step logs. Watched metric changed to `frame/mini/tau50/fps_50/binary_f1`. Establishes clean baselines for all new metrics. |
