...
| [020](020-activation-maximization/) | Activation maximization (input dreaming) | `Planned` | Analysis experiment: freeze 017e checkpoint, optimize input mel to produce target activation maps. Reveals what spectral patterns the model associates with onsets. Sweeps over event context (empty vs real) and conditioning density (0.5-12.0). Griffin-Lim audio inversion. Saliency maps. No training. |
