...
| [021](021-wider-stem/) | Wider conv stem | `Planned` | stem_width 192 -> 256 (+208K params, +0.9%). Tests whether #019's F1 +0.012 / gap_TVD -0.041 gain came from conv capacity vs coincidence signal. Same dataset (taiko2_v1, 80 mel bands). decode_threshold=0.4 for direct comparison to 017f sweep. |
