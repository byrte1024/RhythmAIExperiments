...
| [022b](022b-dual-channel/) | Dual-channel mel + octopus | `Planned` | 177-channel input (80 mel + 97 octopus gradient). Tests whether octopus adds value on top of mel — mel provides energy/silence context, octopus provides pre-computed onset synchrony. Same dataset as #022, config-only change. Key question: does AR F1 exceed mel-only 0.771 and does silence_f1 recover from octopus-only's 0.389? |
