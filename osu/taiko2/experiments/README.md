...
| [019](019-coincidence-input/) | Coincidence input (mel + 13-row summary) | `Planned` | 93-channel input (80 mel + 13 coincidence summary: LSH color, IDF, spike, band averages). Baseline: #017f. Targets silence_overlap_f1 improvement (0.527 -> >= 0.60) and gap_hist_tvd (0.331 -> < 0.30) via onset-importance signal the mel alone lacks. no_coincidence benchmark must show >= 3% F1 drop. Watched metric: fps50 binary F1. |
