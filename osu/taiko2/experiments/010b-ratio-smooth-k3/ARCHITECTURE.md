# Experiment 010b — Ratio decomposition (k=3, 4ch smoothing) · Architecture
...
ratio_input = cursor_tok + div_emb + off_emb
  ...
  → + Conv1d(1→4→1, k=3, p=1) smoothing   [CHANGED: was k=5, 8ch in #010]
...
Reduced from k=5/8ch (#010) to k=3/4ch here — receptive field shrinks
from ~8% to ~5% log-ratio range, halving the smear that #010 showed
while still preventing isolated spikes.
