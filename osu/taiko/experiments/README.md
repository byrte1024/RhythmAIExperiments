...
| 22 | [Blind Selection (Shuffled, No Scores)](experiment_22/) | Pending | Strip audio scores from candidates, shuffle order. Context picks purely from rhythm + snippets. Simplified soft-target loss |
