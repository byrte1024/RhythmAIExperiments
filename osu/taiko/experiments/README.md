...
| 42-B | [Pure Hard CE](experiment_42b/) | Pending | hard_alpha=1.0, frame_tolerance=3. No soft targets. Test if proportional soft targets cause the entropy-distance correlation |
