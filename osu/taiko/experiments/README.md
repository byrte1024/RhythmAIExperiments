...
| 23 | [Shuffled Candidates + Confidence](experiment_23/) | Pending | Shuffled order + softmax probability per candidate (no rank). Middle ground: "when to override" signal without positional bias |
