...
Exp [21](../experiment_21/README.md) proved that relative quality loss produces healthy override behavior (F1=46%, accuracy=61%, both records). But delta remained negative (-0.95pp) because context overrides too broadly - it can't distinguish "audio is wrong" from "audio is right."
...
### Changes from exp [21](../experiment_21/README.md)

**1. Remove audio score/rank features from candidate embeddings**

Previously (exp [21](../experiment_21/README.md)) each candidate got: `gap_emb + snippet_feat + score_proj(score, rank)`.
...
**4. Same infrastructure as exp [20](../experiment_20/README.md)-[21](../experiment_21/README.md)**
...
| Signal | Exp [21](../experiment_21/README.md) | Exp 22 |
|--------|--------|--------|
...
1. **Audio HIT = 69.5%** - frozen, identical to exp [20](../experiment_20/README.md)-[21](../experiment_21/README.md).
...
- Loading exp [19](../experiment_19/README.md)-[21](../experiment_21/README.md) checkpoints for warm-start will need to drop score_proj and reinitialize candidate_combine (different input dim).
...
- false_top1 dropped to 9% - context catches ~70% of audio's mistakes (vs ~20% false_top1 in exp [21](../experiment_21/README.md)). It overrides aggressively when audio is wrong.
...
**What didn't work:**
- Delta still deeply negative (-4.6pp at best vs exp [21](../experiment_21/README.md)'s -0.77pp). Context overrides >50% of predictions - way too many.
