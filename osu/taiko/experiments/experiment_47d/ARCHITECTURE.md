...
Base architecture is EventEmbeddingDetector from exp 44/45. Key change from exp 47-C: gate reads from mean-pooled forward tokens instead of the cursor token.
