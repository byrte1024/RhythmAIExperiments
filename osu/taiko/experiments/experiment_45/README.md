...
Exp [44](../experiment_44/README.md) benchmarks showed random density costs 14pp accuracy and zero density costs 17.9pp. The model uses density conditioning significantly — but the current ±10% jitter at 30% rate during training may be teaching the model to distrust density, weakening a signal that could help more.
...
**Stopped at eval 8. No meaningful improvement over exp [44](../experiment_44/README.md).**

| Metric | Exp 45 (eval 8) | Exp [44](../experiment_44/README.md) (eval 8) | Exp [44](../experiment_44/README.md) ATH (eval 19) |
|---|---|---|---|
| HIT | 71.9% | 72.5% | 73.6% |
| MISS | 27.5% | 27.0% | 25.9% |
...
Consistently ~0.6pp behind exp [44](../experiment_44/README.md) on HIT. Small differences in metronome benchmarks are noise. Random density dropped (32.3% vs exp [44](../experiment_44/README.md)'s ~37%) confirming the model relied more on density, but this didn't translate to better per-sample accuracy.

### AR density adherence

| Exp | Eval | Conditioned | Actual | Ratio |
|---|---|---|---|---|
| [44](../experiment_44/README.md) | 20 | 5.69 | 6.45 | 1.132 (13% over) |
...
- **Per-sample metrics continue to understate AR quality differences.** Same story as exp [42-AR](../experiment_42ar/README.md) — what matters in generation isn't fully captured by validation accuracy.
