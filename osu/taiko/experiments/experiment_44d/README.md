...
Exp [44-C](../experiment_44c/README.md) showed the model knows the right answer [91.8%](../experiment_44c/README.md) of the time (Top-U 3 oracle) but only picks it [73.6%](../experiment_44/README.md) of the time (argmax). The gap between "considered" and "selected" is 18pp.
...
Reuse the softmax probabilities from exp [44](../experiment_44/README.md) (eval 20 checkpoint, subsample 8 val set). For each sample:
