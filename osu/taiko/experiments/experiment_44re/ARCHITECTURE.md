# Experiment 44-RE — Full Architecture Specification

Exact reproduction of experiment 44 on a different machine. Architecture, loss, training, augmentation, and dataset are identical.
...
## Model: EventEmbeddingDetector (no gap ratios)
...
### 3. Event Embeddings (no gap ratios)

For each of 128 context events, compute 3 features:
...
## Environment (reproduction machine)
...
| CUDA | 12.8 |
| cuDNN | 9.10.02 |
| GPU | NVIDIA GeForce RTX 4060 (8 GB, compute 8.9) |
| OS | CachyOS (Linux) |
| torch.compile | Enabled (Linux + Triton) |
| numpy | 2.4.2 |
| scipy | 1.17.1 |
| librosa | 0.11.0 |
| matplotlib | 3.10.8 |

### Original environment (experiment 44)

| Component | Version |
|---|---|
| GPU | NVIDIA GeForce RTX 5070 (12 GB, compute 12.0) |
| OS | Windows 11 |
| torch.compile | Skipped (Windows) |
