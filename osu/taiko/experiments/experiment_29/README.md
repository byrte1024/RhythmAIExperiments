...
- Exp [15](../experiment_15/README.md)-[24](../experiment_24/README.md) (separate paths): context couldn't see audio → couldn't know when to act
- Exp [25](../experiment_25/README.md)-[27](../experiment_27/README.md) (unified fusion): context could see audio but was ignored
- Exp [28](../experiment_28/README.md) (focal loss): redirected gradients to hard cases but model still solved them through audio
...
**Training**: same as exp [27](../experiment_27/README.md) — full dataset (subsample=1), batch=48, evals-per-epoch=4, no focal loss
...
2. **Context standalone accuracy > 0%** — the aux head should reach some level of standalone prediction ability (exp [24](../experiment_24/README.md) showed context in isolation can reach ~53% HIT).
...
**What happened:**
- **Context delta collapsed identically** — 6.0% → 1.5% over 4 evals. Same pattern as exp [25](../experiment_25/README.md)-[28](../experiment_28/README.md).
...
- **Main pathway unaffected** — HIT tracked exp [27](../experiment_27/README.md) closely (68.2% vs 68.6% at eval 4). The aux loss didn't hurt but didn't help either.
