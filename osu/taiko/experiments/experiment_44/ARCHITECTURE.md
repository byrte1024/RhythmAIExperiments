# Experiment 44 — Full Architecture Specification
...
## Key Metrics (ATH at eval 19)

| Metric | Value |
|---|---|
| HIT (≤3% or ±1 frame) | 73.6% |
| MISS (>20% off) | 25.9% |
| Exact match | 54.7% |
| Context delta (acc - no_events acc) | 5.6pp |
| STOP F1 | 0.520 |
| LightAR step0 | 76.7% |
| Metronome benchmark | 42.9% |
