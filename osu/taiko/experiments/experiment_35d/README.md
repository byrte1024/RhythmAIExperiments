...
Exp [35-C](../experiment_35c/README.md) achieved 71.6% HIT with 4.5% sustained context delta — the first breakthrough past 70%. But two issues remain:
...
- Exp [28](../experiment_28/README.md) (gamma=2.0) proved focal loss improves entropy calibration (cleaner HIT/MISS separation)
- Gamma=3.0 is more aggressive than exp [28](../experiment_28/README.md)'s 2.0 — stronger focus on hard cases
- Combined with mel ramps, the hard cases now have context signal available. Exp [28](../experiment_28/README.md) failed to improve HIT because context wasn't available; now it is.
...
2. **Lower entropy** — proven from exp [28](../experiment_28/README.md) that focal loss improves calibration.
...
| | Exp [35-C](../experiment_35c/README.md) (eval 1) | Exp 35-D (eval 1) | Delta |
|---|---|---|---|
| HIT | 66.2% | 64.0% | **-2.2pp** |
