...
Download osu!taiko beatmap packs from the [osu! beatmap pack listing](https://osu.ppy.sh/beatmaps/packs) or a source of your choosing. They must be formatted as: (`.rar`) containing `.osz` files (which are ZIP archives with audio + `.osu` chart files).
